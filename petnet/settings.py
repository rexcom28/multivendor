...
WEB_SITE_URL = f'http://{host_name}/' if DEBUG else 'https:zeus28.pythonanywhere.com/'
URL_API = f'http://{host_name}:8000' if DEBUG else 'https:zeus28.pythonanywhere.com' 
